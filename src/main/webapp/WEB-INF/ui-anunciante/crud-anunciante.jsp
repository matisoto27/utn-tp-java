    ...
    <script>
        window.onload = function () {
            ...
            if (errores) {
            	...
            	var mensajes = {
                    "anunciante_inexistente": "No se encontró un anunciante con el ID proporcionado.",

                    "anunciante_vacio": "El ID del anunciante no puede estar vacío.",
                    "anunciante_invalido": "El ID del anunciante debe ser un número.",
